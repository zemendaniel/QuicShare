...
[Run]
Filename: "{cmd}"; Parameters: "/c netsh advfirewall firewall add rule name=""QuicShare"" dir=in action=allow program=""{app}\QuicShare.exe"" enable=yes"; Flags: runhidden
...
Filename: "{cmd}"; Parameters: "/c netsh advfirewall firewall delete rule name=""QuicShare"" program=""{app}\QuicShare.exe"""; Flags: runhidden
